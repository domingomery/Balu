...
%      singleton*.
%
%      H = BCL_GUI returns the handle to a new BCL_GUI or the handle to
%      the existing singleton*.
%
%      BCL_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in BCL_GUI.M with the given input arguments.
%
%      BCL_GUI('Property','Value',...) creates a new BCL_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Bcl_gui_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Bcl_gui_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Bcl_gui

% Last Modified by GUIDE v2.5 17-Nov-2011 15:48:44

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @Bcl_gui_OpeningFcn, ...
    'gui_OutputFcn',  @Bcl_gui_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before Bcl_gui is made visible.
function Bcl_gui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Bcl_gui (see VARARGIN)

% Choose default command line output for Bcl_gui
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Bcl_gui wait for user response (see UIRESUME)
...
function varargout = Bcl_gui_OutputFcn(hObject, eventdata, handles)
...
% s structur with classifier and feature selector definition (see Bcl_gui.m)
% f features
